...
// react's job is only to describe how the ui should look like, it won't create element or add properties to it, later is taken care by react dom creating element and adding properties and converting it to dom, react simply creates a oblect containing all the properties of the element,

// react don't do thse things because it is used in multiple platforms like web mobile app or pdf, with react, react-native or react pdf, so there is different rendering engines for different platforms.